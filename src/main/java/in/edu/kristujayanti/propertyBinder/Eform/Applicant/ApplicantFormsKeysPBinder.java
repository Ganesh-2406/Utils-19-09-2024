...
//    APPLICANT_WHATSAPP_NUMBER("applicantWhatsappNumber_ApplicantForms_Text", "Applicant Whatsapp Number", String.class),
    LAST_UPDATED("lastUpdated_ApplicantForms_DateTime","last Updated",Long.class),
    LAST_UPDATED_ADMIN("lastUpdatedAdmin_ApplicantForms_DateTime", "Last Updated", Long.class),
...
//    APPLICANT_PERMANENT_NATIONALITY("applicantPermanentNationality_ApplicantForms_Text","Applicant Permanent Nationality",String.class),
    ...
    FATHER_OCCUPATION("fatherOccupation_ApplicantForms_Text","Occupation",String.class),
    FATHER_EDUCATION("fatherEducation_ApplicantForms_Text","Education",String.class),
    FATHER_ANNUAL_INCOME("fatherAnnualIncome_ApplicantForms_Currency","Father Annual Income",Double.class),
    ...
    GUARDIAN_EMPLOYER_DETAIL("guardianEmployerDetail_ApplicantForms_Text","Father's Employer", String.class),
    ...
    GUARDIAN_OCCUPATION("guardianOccupation_ApplicantForms_Text","Occupation",String.class),
    GUARDIAN_PAN_NUMBER("guardianPanNumber_ApplicantForms_Text","Guardian PAN Number",String.class),
    GUARDIAN_ANNUAL_INCOME("guardianAnnualIncome_ApplicantForms_Currency","Guardian Annual Income",Double.class),
    ...
    MOTHER_ANNUAL_INCOME("motherAnnualIncome_ApplicantForms_Currency","Mother Annual Income", Double.class),
    ...
    TENTH_MAXIMUM_MARKS("tenthMaximumMarks_ApplicantForms_Double","10th Marks Scored",Double.class),
...
//    ELEVENTH_AGGREGATE_GRADE_EQUIVALENT_PERCENTAGE_EXCLUDING_LANGUAGES("eleventhAggregateGradeEquivalentPercentageExcludingLanguages_ApplicantForms_Percentage", "11th Aggregate Grade Equivalent Percentage Excluding Languages", Double.class),
    ...
    // 12 th Details
    TWELFTH_VALUATION_SCHEME("twelfthValuationScheme_ApplicantForms_Bool","Eleventh Valuation Scheme", Boolean.class),
    ...
    TWELFTH_MARKS_PERCENTAGE("twelfthMarksPercentage_Percentage", "12th Marks Percentage", Double.class),
...
//UG details
    ...
    MARKS_UG_ARRAY("marksUgArray_ApplicantForms_DocumentArray","Marks  UG Array", Document.class),
...
//    MARKS_UG_ARRAY_AWAITING("gradeUgArrayAwaiting_ApplicantForms_DocumentArray","Marks Awaiting UG Array", Document.class),
    ...
    UG_AGGREGATE_GRADE_INCLUDING_LANGUAGE("ugAggregateGradeIncludingLanguage_ApplicantForms_Percentage","UG Aggregate Grade Including Language ",Double.class),
    UG_AGGREGATE_GRADE_EXCLUDING_LANGUAGE("ugAggregateGradeExcludingLanguage_ApplicantForms_Percentage","UG Aggregate Grade Excluding Language ",Double.class),
