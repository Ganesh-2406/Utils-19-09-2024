...
public enum EformCommonKeysPBinder implements KJUSYSPropertyBinder {
    ...
    APPLICANT_ID("applicantId_EformCommon_Int", "Applicant ID", Integer.class),
    APPLICATION_NUMBER("applicationNumber_EformCommon_Text", "Application Number", String.class),
    APPLICATION_NUMBERS_ARRAY("applicationNumbersArray_EformCommon_TextArray", "Application Number", String.class),
    ...
    APPLICATION_FORM_START_DATE("applicationFormStartDate_EformCommon_DateTime" , "Application Form Start Date", Long.class),
    APPLICATION_FORM_END_DATE("applicationFormEndDate_EformCommon_DateTime" , "Application Form End Date", Long.class),
